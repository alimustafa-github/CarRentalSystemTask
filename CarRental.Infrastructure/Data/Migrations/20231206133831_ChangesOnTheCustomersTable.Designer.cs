...
namespace CarRental.Infrastructure.Data.Migrations
{
    ...
    [Migration("20231206133831_ChangesOnTheCustomersTable")]
    partial class ChangesOnTheCustomersTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarRental.Core.Entities.Customer", b =>
                {
                    ...
                    b.Property<DateTime>("JoinDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 6, 15, 38, 31, 194, DateTimeKind.Local).AddTicks(6747));
            ...
            modelBuilder.Entity("CarRental.Core.Entities.Driver", b =>
                {
                    ...
                    b.Property<DateTime>("ContractEndDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 6, 15, 38, 31, 192, DateTimeKind.Local).AddTicks(6288));
                    ...
                    b.Property<DateTime>("JoinDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 6, 15, 38, 31, 192, DateTimeKind.Local).AddTicks(5727));
            ...
            modelBuilder.Entity("CarRental.Core.Entities.RentedCar", b =>
                {
                    ...
                    b.Property<DateTime>("ReservationEndDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 6, 15, 38, 31, 193, DateTimeKind.Local).AddTicks(9812));

                    b.Property<DateTime>("ReservationStartDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 6, 15, 38, 31, 193, DateTimeKind.Local).AddTicks(9105));
